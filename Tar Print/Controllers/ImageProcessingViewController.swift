    ...
    func loopThroughPixels() -> Bool {
        ...
        for y in 0..<rgbaImageSat.height {
            for x in 0..<rgbaImageSat.width {
                ...
                if (range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].red), target: 54) && range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].green), target: 67) && range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].blue), target: 100)) || (range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].red), target: 184) && range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].green), target: 223) && range(pixel: Int(rgbaImageMap.pixels[3*y*rgbaImageMap.width+3*x].blue), target: 242)){
